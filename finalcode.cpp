...
private:
    ...
    void saveHistory(const Recipe& recipe) {
        ...
        // Append the new recipe name and date to the history
        json j;
...
public:
    ...
    void collectIngredients() {
        while (true) {
            ...
            if (storageLocation == "F" || storageLocation == "f") {
                ...
                newIngredient = Ingredient(name, quantity, expirationDate);  // Set the expiration date
            ...
            // Save the updated ingredients back to storage.json
    ...
    void matchRecipes() {
        ...
        if (option == 1) {
            // Use all ingredients from fridge and pantry
            ...
            // Display all available ingredients from both fridge and pantry
